            ...
            <div className="c_wrap">
                ...
                <div className="layout">
                    ...
                    <div className="contents BUSINESS_INTRO" id="contents">
                        ...
                        <p className="msg_1">전자정부 표준프레임워크는 실행환경, 222개발환경, 관리환경12312312, 운영환경 등 4개의 표준프레임워크 환경과 공통<br/>
                            컴포넌트로 구성된다. 전자정부 및 공공사업에서 웹 어플리케333s14124124dgdgdfg이sadfsdafsdf션 시스템 구축 시 어플리케이션 아키텍처와 기본 <br/>
